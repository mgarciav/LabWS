 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://finanzas/", wsdlLocation = "http://localhost:8084/wsFinanzas/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://finanzas/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/wsFinanzas/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://finanzas/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://finanzas/", "NewWebServicePort"), NewWebService.class, features);
    }
